...
export default class BloodBank extends Component {
    ...
    _renderRow(type,item) {
		return (
            ...
            <TouchableHighlight style={{backgroundColor:"#f5a623", elevation: 1, height: 80}} underlayColor="#878787" onPress={() => {

            }}>
                    <View style={styles.container}>
                        <Image style={styles.image} source={require('./../images/blood.png')}/>
                        <Text style={styles.finalPriceText}>{list.name}</Text>
...
AppRegistry.registerComponent('BloodBank', () => BloodBank);
